<template>
  <div class="app-body">
    ...
    <div class="lead">
      <img src="../../assets/vuexr_illustration_website.svg" style="width: 500px; max-width: 100%;" alt="Vue XR on a smart toaster.">
      <h1 class="main-title">Vue<strong>XR</strong></h1>
      <h2 class="description">Vue-powered Augmented Reality DOM rendering</h2>
      <p class="action">
        <a class="getting-started action-button" href="https://github.com/technokrat-llc/vuexr#getting-started" target="_blank">
          Get Started →
        </a>
      </p>
    </div>
...
<style lang="scss">
  ...
  .demo > .detection > .aruco-wrapper > img {
    max-width: 100%; max-height: 30vh; margin: 1.6rem 0; display: block;
  }
